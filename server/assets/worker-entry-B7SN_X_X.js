...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Cmxf0Je-.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ck0v4stG.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "weddingphotography";
var SERVER_FN_BASE = "/weddingphotography/_serverFn/";
