...
const appCss = "/weddingphotography/assets/styles-rtRFsxS2.css";
...
const gallery2 = "/weddingphotography/assets/gallery-2-CBaxSRdT.jpg";
const $$splitComponentImporter$4 = () => import("./services-CumSad-2.js");
const Route$4 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Investment — Maison Lumière"
    }, {
      property: "og:description",
      content: "Wedding collections, albums and editorial coverage."
    }, {
      property: "og:image",
      content: gallery2
    }, {
...
const gallery3 = "/weddingphotography/assets/gallery-3-No3piGKA.jpg";
const $$splitComponentImporter$3 = () => import("./portfolio-BTxlujov.js");
const Route$3 = createFileRoute("/portfolio")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Portfolio — Maison Lumière"
    }, {
      property: "og:description",
      content: "Selected wedding stories on film and digital."
    }, {
      property: "og:image",
      content: gallery3
    }, {
...
const $$splitComponentImporter$2 = () => import("./contact-CPwxl4qc.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Contact — Maison Lumière"
    }, {
      property: "og:description",
      content: "Begin a conversation. Limited commissions for 2026."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const photographer = "/weddingphotography/assets/photographer-BfT5WAb3.jpg";
const $$splitComponentImporter$1 = () => import("./about-BowzSuc9.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "About — Maison Lumière"
    }, {
      property: "og:description",
      content: "A small studio devoted to slow, cinematic wedding photography."
    }, {
      property: "og:image",
...
const heroImg = "/weddingphotography/assets/hero-couple-D2ALu7AV.jpg";
const $$splitComponentImporter = () => import("./index-BOSScCl6.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Heirloom wedding photography across Italy, France and beyond. Cinematic, timeless storytelling on film and digital."
    }, {
      property: "og:title",
      content: "Maison Lumière — Editorial Wedding Photography"
    }, {
      property: "og:description",
